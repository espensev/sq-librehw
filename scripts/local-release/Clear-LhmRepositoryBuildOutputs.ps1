...
$relativeOutputRoots = @(
    ...
    'Aga.Controls\bin',
    'Aga.Controls\obj',
    'LibreHardwareMonitor.Avalonia.Spike\bin',
    'LibreHardwareMonitor.Avalonia.Spike\obj',
    'LibreHardwareMonitor.Avalonia.Spike.Core\bin',
    'LibreHardwareMonitor.Avalonia.Spike.Core\obj',
    'LibreHardwareMonitor.Avalonia.Spike.Tests\bin',
    'LibreHardwareMonitor.Avalonia.Spike.Tests\obj',
