...
- `docs/features/feature-graph-lanes.md`: promoted and live-verified on SND-DESK, including repaired manual-zoom persistence; operator layout sign-off remains separate.
