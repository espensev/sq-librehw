...
- `docs/features/feature-graph-lanes.md`: promoted on SND-DESK; live lane splits and layout persistence verified, but a manual-zoom startup regression blocks full acceptance.
