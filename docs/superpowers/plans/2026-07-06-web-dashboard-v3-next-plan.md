...
| **D2** | Expansion multi-column layout (use horizontal space) | audit finding | Expanded detail fills width, not a tall narrow strip. **Draft spec: [`feature-web-dashboard-expansion-layout.md`](../../feature-web-dashboard-expansion-layout.md)** — grounded in `console.css:105/270/275` + `xpEl` (`console.js:1021-1065`); acceptance-blocking decisions (B grid-breakout vs D modal; shared `c:` PFD/pinned twin key) open in §9. |
