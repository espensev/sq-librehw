...
in parallel with anything; C was independent of B. **D1 done** (card header reserved gutter, merged). **D2 done** (anchored-overlay expansion, live-gated zero-displacement). **Next: D2a** — direct flight-deck edit controls (plan ready: `2026-07-07-web-deck-controls-d2a.md`, branch `feat/web-deck-controls-d2a`), then D3.
