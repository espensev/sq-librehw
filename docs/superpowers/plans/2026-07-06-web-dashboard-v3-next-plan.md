...
in parallel with anything; C was independent of B. **D1 done** (card header reserved gutter, merged). **D2 done** (anchored-overlay expansion, live-gated zero-displacement). **Next: D2a** — direct flight-deck edit controls (needs its own mini-plan), then D3.
